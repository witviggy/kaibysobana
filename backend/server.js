...
app.use(cors({
  origin: process.env.FRONTEND_URL || 'https://kaibysobana-frontend.purpleisland-0b71ed79.centralindia.azurecontainerapps.io',
  credentials: true
}));
...
const BACKEND_URL = process.env.BACKEND_URL || 'https://kaibysobana-backend.purpleisland-0b71ed79.centralindia.azurecontainerapps.io';
const FRONTEND_URL = process.env.FRONTEND_URL || 'https://kaibysobana-frontend.purpleisland-0b71ed79.centralindia.azurecontainerapps.io';
...
const KEYCLOAK_URL = process.env.KEYCLOAK_URL || 'https://kaibysobana-keycloak.purpleisland-0b71ed79.centralindia.azurecontainerapps.io';
