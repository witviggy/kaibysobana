    ...
    return (
        <div className="min-h-screen bg-zinc-50 flex flex-col items-center justify-center p-4">
            <div className="bg-white rounded-xl shadow-xl border border-zinc-200 p-8 w-full max-w-md text-center">
                ...
                <p className="text-zinc-500 mb-8">Sign in to StitchFlow Dashboard</p>
                ...
                <button
                    onClick={login}
                    className="w-full py-3 px-4 bg-white border border-zinc-300 rounded-lg text-zinc-700 font-medium hover:bg-zinc-50 transition-colors flex items-center justify-center gap-3 shadow-sm"
                >
            ...
            <p className="mt-8 text-xs text-zinc-400">© 2025 Kai by Sobana. All rights reserved.</p>
        </div>
    );
};
